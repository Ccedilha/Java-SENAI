package atividades.atividade7.encapsulamento.banco.principal;


import atividades.atividade7.encapsulamento.banco.modelo.ContaBancaria;
...
public class Main {
    public static void main(String[] args) {
        ContaBancaria pessoa1 = new ContaBancaria("Ian");
        ContaBancaria pessoa2 = new ContaBancaria("Andy");
